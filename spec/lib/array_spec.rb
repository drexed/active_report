...
describe ActiveReport::Array do
  ...
  context 'export to csv without headers for an' do
    it 'array of arrays' do
      sample_csv      = File.read('spec/support/multi_headerless.csv')
    ...
    it 'array' do
      sample_csv      = File.read('spec/support/solo_headerless.csv')
  ...
  context 'import csv without headers returns an' do
    it 'array of arrays' do
      constructed_array = ActiveReport::Array.import('spec/support/multi_headerless.csv')

      expect(constructed_array).to eq(sample_content_alt)
    end

    it 'array' do
      constructed_array = ActiveReport::Array.import('spec/support/solo_headerless.csv')
  ...
  context 'import csv with headers returns an' do
    it 'array of arrays' do
      constructed_array = ActiveReport::Array.import('spec/support/multi_headerless.csv', headers: sample_header)

      expect(constructed_array).to eq(sample_content_alt.dup.unshift(sample_header))
    end

    it 'array' do
      constructed_array = ActiveReport::Array.import('spec/support/solo_headerless.csv', headers: sample_header)
  ...
  context 'import csv with options returns an' do
    it 'array of arrays' do
      constructed_array = ActiveReport::Array.import('spec/support/multi_options.csv', options: { col_sep: ";" })

      expect(constructed_array).to eq([].push(sample_header).concat(sample_content_alt))
    end

    it 'array' do
      constructed_array = ActiveReport::Array.import('spec/support/solo_options.csv', options: { col_sep: ";" })
