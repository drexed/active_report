...
describe ActiveReport::Record do
  ...
  sample_header      = ["Name", "Speed", "Hp", "Crash safety rated", "Created at"]
  sample_header_alt  = ["No.", "Model", "Speed", "Horse Power", "Crash Safety Rated", "Driven On"]

  sample_content     = { name: "Porche", speed: "225", hp: "430", crash_safety_rated: "true", created_at: "2014-08-22T20:59:34.000Z" }
  sample_content_alt = [
  ...
  sample_header_id     = ["Id", "Name", "Speed", "Hp", "Crash safety rated", "Created at"]
  sample_header_alt_id = ["Id", "No.", "Model", "Speed", "Horse Power", "Crash Safety Rated", "Driven On"]

  sample_content_id     = { id: 1, name: "Porche", speed: "225", hp: "430", crash_safety_rated: "true", created_at: "2014-08-22T20:59:34.000Z" }
  sample_content_alt_id = [
  ...
  context 'export to csv all data for an' do
    it 'array of records' do
      ...
      sample_csv      = File.read('spec/support/multi_all.csv')
    ...
    it 'record' do
      ...
      sample_csv      = File.read('spec/support/solo_all.csv')
  ...
  context 'export to csv only values for an' do
    it 'array of records' do
      ...
      sample_csv      = File.read('spec/support/multi_only.csv')
    ...
    it 'record' do
      ...
      sample_csv      = File.read('spec/support/solo_only.csv')
  ...
  context 'export to csv except values for an' do
    it 'array of records' do
      ...
      sample_csv      = File.read('spec/support/multi_except.csv')
    ...
    it 'record' do
      ...
      sample_csv      = File.read('spec/support/solo_except.csv')
  ...
  context 'export to csv with headers for an' do
    it 'array of records' do
      ...
      sample_csv      = File.read('spec/support/multi_headers.csv')
    ...
    it 'record' do
      ...
      sample_csv      = File.read('spec/support/solo_headers.csv')
  ...
  context 'export to csv with options for an' do
    it 'array of records' do
      ...
      sample_csv      = File.read('spec/support/multi_options.csv')
    ...
    it 'record' do
      ...
      sample_csv      = File.read('spec/support/solo_options.csv')
  ...
  context 'import csv without headers returns an' do
    it 'array of hashes' do
      constructed_array = ActiveReport::Record.import('spec/support/multi_all.csv', model: Car)

      expect(constructed_array).to eq(sample_content_alt)
    end

    it 'array with a hash' do
      constructed_array = ActiveReport::Record.import('spec/support/solo_all.csv', model: Car)
  ...
  context 'import csv with headers returns an' do
    it 'array of records' do
      constructed_array = ActiveReport::Record.import('spec/support/multi_headerless.csv', model: Car, headers: sample_header_id)

      expect(constructed_array).to eq(sample_content_alt)
    end

    it 'array with a record' do
      constructed_array = ActiveReport::Record.import('spec/support/solo_headerless.csv', model: Car, headers: sample_header_id)
  ...
  context 'import csv only values returns an' do
    it 'array of records' do
      ...
      constructed_array = ActiveReport::Record.import('spec/support/multi_headerless.csv', model: Car, headers: sample_header_id, only: :name)
    ...
    it 'array with a record' do
      ...
      constructed_array = ActiveReport::Record.import('spec/support/solo_headerless.csv', model: Car, headers: sample_header_id, only: :name)
  ...
  context 'import csv except values returns an' do
    it 'array of records' do
      ...
      constructed_array = ActiveReport::Record.import('spec/support/multi_headerless.csv', model: Car, headers: sample_header_id, except: :name)
    ...
    it 'array with a record' do
      ...
      constructed_array = ActiveReport::Record.import('spec/support/solo_headerless.csv', model: Car, headers: sample_header_id, except: :name)
  ...
  context 'import csv with options returns an' do
    it 'array of records' do
      constructed_array = ActiveReport::Record.import('spec/support/multi_headerless_options.csv', model: Car, headers: sample_header_id, options: { col_sep: ";" })

      expect(constructed_array).to eq(sample_content_alt)
    end

    it 'array with a record' do
      constructed_array = ActiveReport::Record.import('spec/support/solo_headerless_options.csv', model: Car, headers: sample_header_id, options: { col_sep: ";" })
