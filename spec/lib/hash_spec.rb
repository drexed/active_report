...
describe ActiveReport::Hash do
  ...
  sample_content_alt = [
    { "Id" => "1", "Name" => "Ferrari",     "Speed" => "235", "Hp" => "630",  "Crash safety rated" => "true",  "Created at" => "2014-08-23T20:59:34.000Z" },
    { "Id" => "2", "Name" => "Lamborghini", "Speed" => "245", "Hp" => "720",  "Crash safety rated" => "true",  "Created at" => "2014-08-24T20:59:34.000Z" },
    { "Id" => "3", "Name" => "Bugatti",     "Speed" => "256", "Hp" => "1001", "Crash safety rated" => "false", "Created at" => "2014-08-25T20:59:34.000Z" }
  ]
  ...
  context 'import csv without headers returns an' do
    it 'array of hashes' do
      constructed_array = ActiveReport::Hash.import('spec/support/multi_all.csv')

      expect(constructed_array).to eq(sample_content_alt)
    end

    it 'array with a hash' do
      constructed_array = ActiveReport::Hash.import('spec/support/solo_all.csv')
  ...
  context 'import csv with headers returns an' do
    it 'array of hashes' do
      constructed_array = ActiveReport::Hash.import('spec/support/multi_headerless.csv', headers: sample_header)

      expect(constructed_array).to eq(sample_content_alt)
    end

    it 'array with a hash' do
      constructed_array = ActiveReport::Hash.import('spec/support/solo_headerless.csv', headers: sample_header)
  ...
  context 'import csv only values returns an' do
    it 'array of arrays' do
      ...
      constructed_array = ActiveReport::Hash.import('spec/support/multi_headerless.csv', headers: sample_header, only: ["Id", "Name"])
    ...
    it 'array with a hash' do
      ...
      constructed_array = ActiveReport::Hash.import('spec/support/solo_headerless.csv', headers: sample_header, only: "Name")
  ...
  context 'import csv except values returns an' do
    it 'array of arrays' do
      ...
      constructed_array = ActiveReport::Hash.import('spec/support/multi_headerless.csv', headers: sample_header, except: ["Id", "Name"])
    ...
    it 'array with a hash' do
      ...
      constructed_array = ActiveReport::Hash.import('spec/support/solo_headerless.csv', headers: sample_header, except: "Name")
  ...
  context 'import csv with options returns an' do
    it 'array of hashes' do
      constructed_array = ActiveReport::Hash.import('spec/support/multi_headerless_options.csv', headers: sample_header, options: { col_sep: ";" })

      expect(constructed_array).to eq(sample_content_alt)
    end

    it 'array with a hash' do
      constructed_array = ActiveReport::Hash.import('spec/support/solo_headerless_options.csv', headers: sample_header, options: { col_sep: ";" })
